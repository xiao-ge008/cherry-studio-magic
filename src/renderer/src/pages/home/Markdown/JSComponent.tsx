...
const JSComponentHTMLRenderer: React.FC<{ content: string; componentName: string; children?: React.ReactNode }> = ({
  content,
  componentName,
  children
}) => {
  ...
  return (
    <div className="js-component-wrapper flex w-full flex-col">
      <div
        ref={containerRef}
        style={{
          maxWidth: '100%',
      ...
      {children && (
        <div
          className="js-component-text-content mt-4 w-full"
          style={{
            display: 'block',
            position: 'relative',
            zIndex: 1
