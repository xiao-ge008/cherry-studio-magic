...
import { Button, Form, Input, Modal, Popover, Select, SelectProps } from 'antd'
...
const PopupContainer: React.FC<Props> = ({ resolve }) => {
  ...
  const onFinish = (values: FieldType) => {
    ...
    const _emoji = emoji || getLeadingEmoji(trimmedName)
  ...
  return (
    <Modal
      ...
      <Form
        ...
        <Form.Item name="name" label={t('agents.add.name.label')} rules={[{ required: true, whitespace: true }]}>
